...
trainer_para.exp_name = "scBERT_" # experiment name
#-----> dataset
trainer_para.task_type = "regression" # "classification","regression"
trainer_para.class_nb = 1 # 1 for regression
...
# loss is MSE
trainer_para.loss= torch.nn.MSELoss  # MSE loss function class but not create instance here
...
#-----> metrics 
trainer_para.metrics_names = ["MSE","CosSim"] # list of metrics name
...
trainer_para.ckpt_format:str = "_{epoch:02d}-{MSE:.2f}" # check_point format 
